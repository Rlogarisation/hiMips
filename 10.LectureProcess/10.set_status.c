/*
z5206267@corelli:~/COMP1521/LectureProcess$ ./set_status 
Environment variable 'STATUS' has value 'great'
z5206267@corelli:~/COMP1521/LectureProcess$ ./get_status 
Environment variable 'STATUS' has value '(null)'
*/

// The setting would not change globally, would only change to your child.
#include <stdio.h>
#include <stdlib.h>
#include <spawn.h>
#include <sys/wait.h>
