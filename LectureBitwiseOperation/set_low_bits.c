...
int main(int argc, char *argv[]) {
    ...
    /*
    Mask is used to filter the required numbers:
    mask = 1 -> 0000000000000001
    e.g. I wish to see the bottom 5 bits only, and filter out all the rest,
    1<<5 -> 0000000000100000
    mask - 1 -> 0000000000011111
    */
