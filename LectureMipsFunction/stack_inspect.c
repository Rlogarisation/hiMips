// We only initial a array with size of 1,
// but we assign values to the array up to size of 16.
// Which cause memory disorder in gcc or clang with no error checking.
